...
def getCityWeather_RealTime(cityID):
    ...
    try:
        ...
        content = city + ",今天天气情况为 :" + " " + temp + "℃ " + fx + fl + " " + "相对湿度" + sd + " " + "发布时间:" + tm
...
def main():
    ...
    for city in cityList_main:
        ...
        tian = title_small + twitter['message']

    for city in cityList_main:
        title_small = "全天: "
        twitter = getCityWeather_AllDay(city['code'])
        shi = title_small + twitter["message"]
        # ha = getCityWeatherDetail_SixDay(city['code'])
...
if __name__ == "__main__":
    ...
    while i:
        ...
        # """ 你的 APPID AK SK """
        # APP_ID = '你的 App ID'
        # API_KEY = '1a7c5a0df5844566b6da5f7d433733b4'
        # SECRET_KEY = 'da6f1037d8ca48288bf79f4f16bbcf09'
