...
strProductKey ="Windows Key: " & WinProductKey & vbNewLine & vbNewLine & " lemon自制 "& vbNewLine & vbNewLine & "-----------------------------------------点击确定下一步复制"
...
ret = InputBox(vbNewLine & "右击，弹出选择复制："& vbNewLine & vbNewLine & "[ 点击确定或取消退出继续]" ,"Windows 查看器",WinProductKey)
